...
const resultCopy = [
  {
    ...
    tag: "人话大师型",
    explanations: [
      "这段话还挺自然的，至少不像从模板里复制出来的。它有情绪、有具体表达，读起来像真的有人在说话。",
      "这段话的优点是没端着。它知道自己要说什么，也没有非要把普通话包装成年度汇报。",
      "这里面有人味，句子也能正常呼吸。读者不用边看边翻译，基本能直接接住意思。"
    ],
    suggestions: [
      "保持这种直说，别突然上价值。",
      "最有态度的那句可以放前面，截图更抓人。",
      "再补一个具体场景，就更有画面了。",
      "能短就短一点，别给好句子加太多尾巴。",
      "保留一点自己的语气，这比十个高级词都管用。"
    ],
    variants: [
      {
        roastTitle: "这段话挺能处，像朋友发来的，不像模板群发的。",
        problems: ["人味挺足，没有一开口就把 PPT 叫醒。", "信息有落点，读者不用开脑补模式。", "语气自然，像朋友说话，不像系统通知。"],
        suggestions: ["保持这种直说，别突然上价值。", "最有态度的那句可以放前面，截图更抓人。", "再补一个具体场景，就更有画面了。"],
        rewrite: "“这段话已经挺自然了，别过度包装，把最想说的重点提前就行。”"
      },
      {
        roastTitle: "还行，像人说的，不像 PPT 自己长出来的。",
      ...
      {
        roastTitle: "这段话至少有人在场，不是 AI 和 KPI 的双人舞。",
      ...
      {
        roastTitle: "这段话挺会聊天，属于看完不会想把软件关掉的水平。",
      ...
      {
        roastTitle: "这文案人味浓度达标，不用送去套话工厂返修。",
  ...
  },
  {
    ...
    tag: "基本会说人话型",
    explanations: [
      "它不是不像人话，只是偶尔会突然坐直。大意能懂，但有几句像是准备交给老师检查。",
      "这段话能看懂，也不算空，但有些地方还是太稳了。稳到读者点头之后，可能转身就忘。",
      "这里面有真实意思，只是外面套了一层正式滤镜。再松一点，就会更像聊天而不是汇报。"
    ],
    suggestions: [
      "少说“能力提升”，多说你到底干了啥。",
      "别急着上价值，先把话说明白。",
    ...
    variants: [
      {
        ...
        suggestions: ["少说“能力提升”，多说你到底干了啥。", "把最关键的一句提前，别让读者找线索。", "删掉一两个装成熟的词，马上年轻十岁。"],
        rewrite: "“这段话能用，但可以更直接：先讲具体事，再讲你的想法。”"
      },
      {
        roastTitle: "领导看了能点头，同学看了也不至于沉默，算过关。",
      ...
      {
        roastTitle: "这段话像刚从模板里逃出来，还没完全自由。",
      ...
      {
        roastTitle: "不是灾难现场，但也不是热评区爆款，还能再抢救。",
      ...
      {
        roastTitle: "这段话像人话的精装修版，还不错，就是有点怕被挑错。",
  ...
  },
  {
    ...
    tag: "轻微套话型",
    explanations: [
      "这段话的问题不是不努力，而是太努力装正式了。每句话都像“我在认真完成任务”，但真正想说什么反而被藏起来了。",
      "它不是完全不像人话，只是 PPT 味有点冲。词都挺高级，但具体干了啥、想表达啥，读完还是得猜。",
      "这段文字有点像把普通话送去职场培训了一圈。回来确实更规矩了，但也没那么像本人说的了。"
    ],
    suggestions: [
      "少说“赋能提升”，直接说你到底做了什么。",
      "把“打造能力矩阵”翻译成人话：你具体会什么？",
      "别写一堆万能句，换成只有这件事才会出现的细节。",
      "能说“我今天很累”，就别写“当前状态存在一定疲惫感”。",
      "少一点 PPT 味，多一点真人味。"
    ],
    variants: [
      {
        roastTitle: "这段话像把“高级感”按进榨汁机，出来有点糊。",
      ...
      {
        roastTitle: "这段话像简历模板在努力装朋友聊天。",
        problems: ["表达太泛，像复制到哪都不违和。", "关键词不少，但真正能记住的少。", "语气比较端，像在给文本写评语。"],
        suggestions: ["把“能力强”换成“做过什么”。", "别只写优点，写一个具体表现。", "少用万能形容词，多给读者一点证据。"],
        rewrite: "“简单说，用具体经历替代自我表扬，这段话会立刻可信很多。”"
      },
      {
        roastTitle: "每个字都认识，连起来像在参加无效培训。",
        problems: ["句子有点满，读起来不够轻松。", "抽象词占位太多，具体画面不足。", "有一些正确废话，听着对，但没留下东西。"],
        suggestions: ["一句话只讲一个重点，别塞满。", "把“方向正确”换成“具体怎么做”。", "遇到大词先问：能不能举例？不能就删。"],
        rewrite: "“这段话要少一点概念，多一点事情本身，读者才不会迷路。”"
      },
      {
        roastTitle: "这段文字在套话边缘试探，再往前一步就要进会议室了。",
        problems: ["人话还在，但被正式语气盖住了。", "内容有意思，只是外面套了一层塑封膜。", "有些表达像为了显得稳，结果显得虚。"],
        suggestions: ["先把话说成聊天版，再挑需要保留的正式词。", "少写“持续推进”，多写“下一步做什么”。", "保留一点真人语气，别把人从文案里删掉。"],
  ...
  },
  {
    ...
    tag: "AI味过重型",
    explanations: [
      "这段话太会摆姿势了，像每一句都在等系统打分。问题是它很完整，但不太像人临时想说的话。",
      "它的 AI 味主要来自“正确但悬浮”。词都很安全，句子也很顺，就是具体的人和事没怎么出现。",
      "这段文字像从生成框里刚端出来，还没经过真人嘴巴。读起来很像总结，少了点真实反应。"
    ],
    suggestions: [
      "别一上来就“随着时代发展”，先说具体发生了什么。",
      "少说“积极拥抱”，多说你准备怎么用、怎么做。",
      "把“正在深刻改变”换成一个能看见的变化。",
      "删掉最像模板的开头和结尾，通常它们没什么用。",
      "让句子有一点人的停顿和态度，别全程像自动播报。"
    ],
    variants: [
      {
        roastTitle: "AI 看了都想申请工伤：这段太像刚从生成按钮里端出来的。",
      ...
      {
        roastTitle: "这段文字像 AI 写完自己点了个赞，读者还在加载中。",
  ...
  },
  {
    ...
    tag: "领导废话型",
    explanations: [
      "这段话最大的问题是太像开会开出来的。听起来很有气势，但谁要做什么、什么时候做完，基本还在云里。",
      "它不是没内容，是内容被口号盖住了。每个词都很熟，连起来却像一阵会场空调风。",
      "这段文字的班味很足，人味偏低。读完感觉确实很重视，但具体重视了什么，还得继续猜。"
    ],
    suggestions: [
      "少说“凝聚共识”，先说现在到底要解决什么。",
      "把“狠抓落实”翻译成人话：谁来做、做哪一步？",
      "别让句子只负责响亮，也得负责有用。",
      "把“高质量发展”换成一个能看见的结果。",
      "一句话里少塞几个口号，读者真的会掉线。"
    ],
    variants: [
      ...
      {
        roastTitle: "这段不是文案，是会议纪要在练核心，核心很用力但看不见。",
      ...
      {
        roastTitle: "读完感觉被格式化了一遍，脑子里只剩“落实”在回响。",
